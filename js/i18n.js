...
const I18n = (() => {
  ...
  const translations = {
    id: {
      ...
      'hero.title1': 'Berapa Banyak Momen Berharga',
      'hero.title2': 'yang Hilang Karena Kamu Tumbang Bulan Ini?',
      ...
      'problem.card1.title': 'Tubuh Remuk Meski Cukup Tidur?',
      'problem.card1.text': 'Tidur 8 jam tapi tetap bangun dengan badan berat dan tak bertenaga? Tubuhmu bukan sekadar lelah, ia sedang kewalahan bertarung melawan racun dan radikal bebas setiap detiknya.',
      'problem.card2.title': 'Pertahanan Tubuh Jebol',
      'problem.card2.text': 'Teman kantor batuk sedikit, kamu langsung tertular? Cuaca berubah, kamu langsung demam? Jangan anggap remeh, ini tanda perisai alami tubuhmu sudah tidak berfungsi.',
      'problem.card3.title': 'Bom Waktu Obat Sintetis',
      'problem.card3.text': 'Sedikit-sedikit minum obat warung? Sadari bahwa ginjal dan hatimu bekerja terlalu keras memproses bahan kimia tersebut. Solusi instan hari ini bisa jadi penyakit kronis di masa depan.',
      ...
      'solution.title': 'Putus Siklus Sakit-Sakitmu dengan Kekuatan Alami dari Tanah Jawa.',
      'solution.text': 'Jalan keluar dari ketergantungan obat kimia. Kembalikan kendali atas kesehatanmu tanpa risiko efek samping jangka panjang. 100% Organik, murni untuk perisai tubuhmu.',
      'solution.feature1.title': 'Jahe Merah Premium',
      'solution.feature1.text': 'Bersumber dari tanah Jawa, Indonesia',
      ...
      'products.title': 'Siapa Bilang Membangun Imun Harus Tersiksa Rasa Pahit?',
      'products.desc': 'Tinggalkan rasa obat yang mengerikan. Nikmati perisai anti-inflamasi terkuat dalam 4 varian rasa yang memanjakan lidah Anda setiap hari.',
      ...
      'products.coconut.image': 'Perpaduan Kelapa Creamy',
      'products.coconut.badge': 'Rasa Baru',
      'products.coconut.name': 'Kelapa Creamy',
      ...
      'comparison.coconut': 'Kelapa Creamy',
      ...
      'footer.product.coconut': 'Kelapa Creamy',
    ...
    en: {
      ...
      'hero.title1': 'How Many Precious Moments',
      'hero.title2': 'Lost Because You Fell Sick This Month?',
      'hero.subtitle': 'Often feel tired and easily fall sick just because the weather changes? It\'s not just a lack of rest. It\'s a warning alarm from your breached immune system. Ignoring it now means preparing for expensive hospital bills tomorrow.',
      'hero.cta1': 'Stop Getting Sick Easily',
      ...
      'solution.title': 'Break Your Sickness Cycle with Natural Power from Java.',
      'solution.text': 'The way out of chemical medicine dependency. Regain control of your health without the risk of long-term side effects. 100% Organic, pure shield for your body.',
      'solution.feature1.title': 'Premium Red Ginger',
      'solution.feature1.text': 'Sourced from the heart of Java, Indonesia',
      ...
      'products.title': 'Who Says Building Immunity Must Be Bitter?',
      'products.desc': 'Leave the terrible medicine taste behind. Enjoy the strongest anti-inflammatory shield in 4 delicious flavors every day.',
      ...
      'products.coconut.image': 'Creamy Coconut Blend',
      'products.coconut.badge': 'New Flavor',
      'products.coconut.name': 'Creamy Coconut',
      ...
      'comparison.original': 'Original',
      'comparison.coconut': 'Creamy Coconut',
      ...
      'footer.product.coconut': 'Creamy Coconut',
